...
export const projects: Project[] = [
  {
    ...
    summary:
      "Real-time control loop for balance using IMU fusion & PID on STM32 with custom sensor filtering and motor control algorithms.",
    images: [
  ...
  },
  {
    ...
    summary:
      "Complete arithmetic logic unit implementation with comprehensive testbench suite and FPGA synthesis targeting.",
  ...
  },
  {
    ...
    summary:
      "FPGA-based digital clock with alarm functionality, 7-segment display, and user interface controls.",
    images: ["/api/placeholder/600/400", "/api/placeholder/600/400"],
  ...
  },
  {
    ...
    summary:
      "Precision stepper motor control system with H-bridge driver circuit and microstepping capability for CNC applications.",
    images: [
      "/api/placeholder/600/400",
      "/api/placeholder/600/400",
      "/api/placeholder/600/400",
  ...
  },
  {
    ...
    summary:
      "IoT-based home automation system with sensor integration, remote monitoring, and mobile app control.",
    images: ["/api/placeholder/600/400", "/api/placeholder/600/400"],
  ...
  },
  {
    ...
    summary:
      "FPGA-based traffic light control system with pedestrian crossing and emergency vehicle detection.",
